...
class XMLGenerator:
    def __init__(self, diagram):
        ...
        self.transitions = diagram.transitions
    ...
    def compute(self, file):
        ...
        for transition in self.transitions:
            print('\t\t<Transition source="{}" target="{}" name="{}" prob="{}" />'.format(transition.source,
                                                                                          transition.target,
                                                                                          transition.name,
                                                                                          transition.prob), file=file)
...
class ActivityDiagram:
    ...
    def getXml(self, file):
        XMLGenerator(self).compute(file)
